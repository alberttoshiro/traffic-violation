...
public class TrafficViolationTest {
    ...
    public void test() {
        ...
        Map<String, ?> violation = of("Actual Speed", 120, "Speed Limit", 100, "Type", "speed");
        ...
        LOG.info("dmnModelUT : ", dmnModelUT);
        ...
        assertEquals(DecisionEvaluationStatus.SUCCEEDED,
                dmnResult.getDecisionResultByName("Should the driver be suspended?").getEvaluationStatus());
